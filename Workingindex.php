...
<div id="card" style="margin-top: -2%;margin-bottom: 1px;">
    <div class="front">
        <div class="paper">
		<img class="poster"
                                   src="https://gatewayjuniorstorage.blob.core.windows.net/images/thurgau_db130bb46e0a4d91805eec87b11328dc.jpg"/>

            <h2 style="margin-top: -2%;">. . . .</h2>
	<legend style="font-size= 90%;margin-top: -2%;">Wilkommen! Auf dieser Seite können sie anhand einiger Kriterien, Ihre ideale Gemeinde im Kanton Thurgau finden.</legend>
            ...
            <div class="form-group">
                <div class="form-group">
                    ...
                    <div class="form-check">
                            <label><input id="Sa" type="checkbox" class="form-check-input" value="">Seeanstoss</label>
                    </div>
    ...
    $(document).ready(function(){
        $("#go").click(function(){
            ...
            $.post('DBHandler.php' , 'ps=' + $("#ps").val()+'&age=' + $("#age").val()+'&gs=' + $("#gs").val() + '&Einw=' + $("#ewz").val() + '&sf=' + $("#sf").val() +'&eh=' + $("#eh").val() + '&Sa=' + sa, function(response) {
                ...
                $("#gemName").text("Deine ideale Gemeinde: "+array[0]);
